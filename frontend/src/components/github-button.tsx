...
function GitHubButton({ url }: { url?: string }) {
  return (
    <Link
      ...
      className="flex cursor-pointer items-center gap-[3px] rounded-md bg-primary py-0.5 pr-1.5 text-xs font-semibold text-secondary shadow-xs ring-1 ring-primary outline-focus-ring transition duration-100 ease-linear ring-inset hover:bg-primary_hover focus-visible:outline-2 focus-visible:outline-offset-2 pl-[5px]"
    >
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
        fill="none"
        className="size-[14px] text-fg-quaternary"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <span className="font-side font-bold text-sm mt-px">GitHub</span>
      <svg
        viewBox="0 0 24 24"
        width="24"
        height="24"
        ...
        aria-hidden="true"
        className="size-3 stroke-[3px] text-fg-quaternary"
      >
